...
describe('stapi', () => {
  describe('#searchCharactersByName()', () => {
    it('should return a list of matching characters', () => {
    ...
    it('should call stapi passing a name as parameter', done => {
      const originalFunction = axios.post
      axios.post = (url, body) => {
  ...
  describe('#getCharacterDetails', () => {
    it('should return a specific character details', () => {
    ...
    it('should call stapi passing a character\'s uid', done => {
      const originalFunction = axios.get
      axios.get = url => {
